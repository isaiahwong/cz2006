...
class HIITRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HIITRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'hiit'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hiit')
    ..aOM<WorkoutUser>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'user', subBuilder: WorkoutUser.create)
    ..aOM<HIITRoutine>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routine', subBuilder: HIITRoutine.create)
    ..hasRequiredFields = false
  ...
  factory HIITRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HIITRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  HIITRequest clone() => HIITRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HIITRequest copyWith(void Function(HIITRequest) updates) => super.copyWith((message) => updates(message as HIITRequest)) as HIITRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static HIITRequest create() => HIITRequest._();
  HIITRequest createEmptyInstance() => create();
  static $pb.PbList<HIITRequest> createRepeated() => $pb.PbList<HIITRequest>();
  @$core.pragma('dart2js:noInline')
  static HIITRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HIITRequest>(create);
  static HIITRequest? _defaultInstance;
