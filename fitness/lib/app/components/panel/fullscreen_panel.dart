      ...
      builder: (state) {
        return Scaffold(
          body: _FullScreenPanel(
            ...
            panelMinSize: state.status is FullScreenStatusInactive ? 0 : 80,
...
/// Adapted from https://github.com/luciano-work/we_slide

/// This class used to control animations, using methods like hide or show
class FullScreenController extends ValueNotifier<bool> {
  /// WeslideController Construction
  FullScreenController() : super(false);

  /// show _FullScreenPanel Panel
  void show() => value = true;

  /// hide _FullScreenPanel Panel
  void hide() => value = false;

  /// Returns if the _FullScreenPanel Panel is opened or not
...
class _FullScreenPanel extends StatefulWidget {
  ...
  _FullScreenPanel({
    ...
    if (controller == null) {
      ...
      this.controller = FullScreenController();
    }
  }
...
class _AppSlideState extends State<_FullScreenPanel>
  ...
  FullScreenController get _effectiveController => widget.controller!;
  ...
  @override
  void didUpdateWidget(_FullScreenPanel oldWidget) {
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.circular(_panelborderRadius.value),
                      ),
                      child: ClipRRect(
                        borderRadius: BorderRadius.only(
